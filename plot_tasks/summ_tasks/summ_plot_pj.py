...
def summ_plot_pj(conf_suffix, dims_ls, conc_list, temp_list, arm_num_list, task_list, color_list, marker_list, sp_suffix='', flag_suffix=''):
    '''
    Summary plot (design fixed) of patch angle of junction.
    ...
    ylim_std = (0, 90)
    ylim_skw = (-1.3, 1.3)
    y_var = rf'Patch Angles of Junction ($^\circ$)'
    #### conf ends ####
    ...
    # load data
    summary_dic, savepath = SL(ns_pj_plot, data, varname)
    # plot
    plt = summ_plot(summary_dic, plot_confs, data, task_list, color_list, marker_list, special_tasks, sp_suffix=sp_suffix, flag_suffix=flag_suffix)
