...
def summ_plot_kj_jun(jun_list, dims_ls, conc_list, temp_list, arm_num_list, task_list, color_list, marker_list, sp_suffix='', flag_suffix=''):
    '''
    Summary plot (#unpaired at junction varied) of k2 of the junction.
    ...
    plot_confs = (xlim, ylim_avg, ylim_std, ylim_skw, y_var)
    # load
    jun_summ_dic, savepath = SL_jun(ns_kj_plot, data, conc_list, varname)
    #### Plot Summaries ####
